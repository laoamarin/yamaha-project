/**
 * Sunday 12 Jul 2026 performance roster.
 * Source: YAMAHA COSMIC CONCERT 2026 student list (12 ก.ค. 2569).
 * JSON review file: seed/cosmic-concert-2026-07-12-schedule.json
 */
import scheduleJson from "./cosmic-concert-2026-07-12-schedule.json";
